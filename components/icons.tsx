export function MicIcon({ size = 22, color = "#fff" }: { size?: number; color?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
export function GearIcon({ size = 15, color = "#8a8680" }: { size?: number; color?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ChevronDownIcon({ size = 10, color = "#8a8680" }: { size?: number; color?: string }) {
  return (
